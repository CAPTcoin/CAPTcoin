...
int64 nChainStartTime = 1404305702;
...
const string strMessageMagic = "CAPTcoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in CAPTcoin
    bool fStrictPayToScriptHash = true; // Always active in CAPTcoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CAPTcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2nd July";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1404305703;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 5543713;
        ...
        assert(block.hashMerkleRoot == uint256("0x0629525ce95947daa0213edabddc86e37fa51577dcb43b7f1e3019f8029d99fe"));
